      ...
      <View style={{flex: 1}}>
        ...
        <View style={[styles.main, {width: '100%'}]}>
          <View style={[styles.main1, {width: '100%'}]}>
            {image ? <Image style={styles.img} source={{uri: image}} /> : null}
            {!name ? (
        ...
        <TouchableOpacity delayPressIn={0} onPress={() => validateUser()}>
          <View style={[styles.drawer]}>
            <View style={styles.row}>
              <View style={styles.view1}>
                <View style={styles.iconView}>
                  <Image
                    style={{height: 26, width: 26, marginLeft: 3}}
        ...
        <TouchableOpacity
          ...
          <View style={styles.row}>
            <View style={styles.view1}>
              <View style={styles.iconView}>
                <Image
                  style={{height: 24, width: 24, marginLeft: 4, marginRight: 4}}
