...
manageFamily=async()=>{
  ...
  else if(this.state.mobile=='' || reg1.test(this.state.mobile) === false){
        ...
        <View style={[styles.card,{marginTop:10}]}>
             <View style={styles.container1}>
                 <View style={{}}>
                   ...
                   {item.relation==null||item.relation==0||item.relation==''?null:  <Text style={styles.text}>{`Relationship : ${item.relation==null?'':item.relation}`}</Text>}
                     <Text style={styles.text}>{`Mobile Number : ${item.mobile}`}</Text>
                 </View>
...
render(){
  ...
  value=`${dd}-${mm}-${yyyy}`
  console.log('this user selected date',value)
        return(
              ...
              <Header
               ...
               />
                ...
                <View style={{
                    ...
                    onPress={()=>this.props.navigation.navigate('SecondaryUser',{
                      data:this.state.data,
                      my_fixed_deposit_id:this.state.my_fixed_deposit_id
                    }
                    )}
                    style={[styles.button1,{backgroundColor:this.state.data? colors.bc:'grey',}]}>
  ...
  {/* Blow for add family popup */}
                   ...
                   <Dialog
                      dialogStyle={{width:'98%',paddingHorizontal:0,height:'100%',paddingTop:0}}
                    ...
                    <Text style={styles.better}>Date of Birth</Text>
                     ...
                     <TouchableOpacity onPress={()=>this.setState({open:true})} style={styles.dropCal}>
                    ...
                    <Text style={styles.better}>Relationship</Text>
                      ...
                      <RNPickerSelect
                                         ...
                                         value={this.state.relation==null||0?'':this.state.relation}
                                         useNativeAndroidPickerStyle={false}
