...
// import { View,Text,Image,ScrollView,TextInput,Platform,BackHandler,TouchableOpacity} from 'react-native';
...
//   mother_maiden_name: yup.string().required('Please enter your mother name '),
//   address1: yup.string().required('Please enter your address line1 '),
//   address2: yup.string().required('Please enter your address line2 '),
//   marital_status: yup.string().required('Please select marital status '),
//   income_group: yup.string().required('Please select annual income'),
...
//     const data1=route.params.data[1]
...
//     const [residential_status,set_residential_status]=useState(data1.residential_status)
...
//       //  }
//       if (values.marital_status == 1 && spouse_name=='') {
...
//         email:values.email,
//         address_communication: values.address1,
//         address_permanent: values.address2,
...
//         annual_income: values.income_group,
//         fd_user_id:user_id,
//         user_id:user_id,
//         user_dob:data1.dob,
//         pan:pan,
...
//       data.append('father_spouse_name', values.father_name);
//       data.append('mother_maiden_name', values.mother_name);
//       data.append('pan', pan);
...
//       data.append('income_group', values.income_group);
...
//       <Formik
//       initialValues={{
//         name:data1.name==0||data1.name==null?'':data1.name,
//         email:data1.email==0?'':data1.email,
//         mobile:data1.mobile==0?'':data1.mobile,
//         father_name:data1.father_spouse_name==0?'':data1.father_spouse_name,
//         mother_maiden_name:data1.mother_maiden_name==0?'':data1.mother_maiden_name,
//         address1:data1.address1==0?'':data1.address1,
//         address2:data1.address2==0?'':data1.address2,
//         marital_status:data1.marital_status==0?'':data1.marital_status,
//         income_group:data1.income_group==0?'':data1.income_group,
//         occupation:data1.occupation==0?'':data1.occupation,
//        }}
//         onSubmit={values =>
//           validateUser(values)
//         }
...
//                             <Text style={styles.warn}>{errors.father_name}</Text>
//                           )}
//               </View>
//               <View style={styles.row}>
...
//                   onChangeText={handleChange('mother_maiden_name')}
//                   editable={true}
//                   placeholder="Please enter mother maiden name"
//                 />
//               </View>
//               <View style={styles.error}>
//                           {errors.mother_maiden_name && touched.mother_maiden_name && (
//                             <Text style={styles.warn}>{errors.mother_maiden_name}</Text>
//                           )}
//               </View>
//               <View style={styles.row}>
...
//               <View style={styles.drop}>
//                 <RNPickerSelect
//                   onValueChange={handleChange('income_group')}
//                   items={Incom_Group}
//                   style={{
//                     inputAndroid: {
//                       color: colors.textColor,
...
//                     },
//                   }}
//                   value={values.income_group}
//                   useNativeAndroidPickerStyle={false}
//                   placeholder={{label: 'Select income group', value: 0}}
//                 />
//               </View>
//               <View style={styles.error}>
//                           {errors.income_group && touched.income_group && (
//                             <Text style={styles.warn}>{errors.income_group}</Text>
//                           )}
//               </View>
//               <View style={styles.row}>
...
//                             <Text style={styles.warn}>{errors.marital_status}</Text>
//                           )}
//               </View>
//               {values.marital_status==1?<View>
//               <View style={styles.row}>
            ...
            /> */}
                      ...
                      />
                       ...
                       <View style={styles.drop}>
                            <TextInput
                             style={styles.input}
                             value={father_name==0||father_name==null?'':father_name}
                             editable={true}
