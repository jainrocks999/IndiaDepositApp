...
console.log('this is both branch type',data1);
useEffect(()=>{
    const backAction = () => {
        navigation.goBack()
        return true;
...
const renderMab1=()=>{
  ...
  const download1=async(item)=>{
    try {
      ...
      item.type=='Regular'?'fdRegular':
      item.type=='Senior Citizen'?'FDSenior Citizen':
      item.type=='Female'?'SBFemale':
      item.type=='Zero Balance'?'SBZeroBalance':''
      )
               ...
               <ScrollView>
                 ...
                 <View>
                  ...
                  <View>
                     ...
                     <View style={styles.row}>
                         <Text style={styles.value}>{data1.joining_kit==0?'No':'Yes'}</Text>
                         <Text style={styles.value}>{data2.joining_kit==0?'No':'Yes'}</Text>
                     </View>
                  </View>
                  <View>
                     <View style={styles.container}>
                  ...
                  <View>
                     ...
                     <View style={styles.row}>
                         <Text style={styles.value}>{data1.ecs_imps_neft_rtgs==0?'No':'Yes'}</Text>
                         <Text style={styles.value}>{data2.ecs_imps_neft_rtgs==0?'No':'Yes'}</Text>
                     </View>
                  </View>
                  ...
                  <View>
                     ...
                     <View style={styles.row}>
                         <Text style={styles.value}>{data1.phone_banking==0?'No':'Yes'}</Text>
                         <Text style={styles.value}>{data2.phone_banking==0?'No':'Yes'}</Text>
                     </View>
                  </View>
                  <View>
                     <View style={styles.container}>
                  ...
                  <View>
                     ...
                     <View style={styles.row}>
                         <Text style={styles.value}>{data1.locker_facility==0?'No':'Yes'}</Text>
                         <Text style={styles.value}>{data2.locker_facility==0?'No':'Yes'}</Text>
                     </View>
                  </View>
                  <View>
                     <View style={styles.container}>
                  ...
                  <View>
                     ...
                     <View style={styles.row}>
                         <Text style={styles.value}>{data1.free_atm_transaction_otherbank}</Text>
                         <Text style={styles.value}>{data2.free_atm_transaction_otherbank}</Text>
                     </View>
                  </View>
                  <View>
                     <View style={styles.container}>
                     ...
                     <View style={styles.row}>
                         ...
                         <Text style={styles.value}>{data2.pan_required==0?'No':'Yes'}</Text>
                     </View>
                  </View>
