      ...
      <ScrollView>
        <View style={styles.view1}>
            ...
            <View style={styles.view2}>
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={styles.item}>
                  {parseInt(details.principal_amount).toFixed(0)}
                </Text>
              </View>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={styles.item}>
                  {(
                    ...
                    Math.pow(1 + details.rate / 100, period)
                  ).toFixed(0)}
                </Text>
              </View>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.view2}>
              ...
              <Text
                style={[styles.item1, {textAlign: 'center'}]}>{`FD Type`}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.view4}>
          <View style={styles.container}>
            <View style={styles.view2}>
              <Text style={styles.item}>
                {details.sb_ac_require == 0 ? 'No' : 'Yes'}
              </Text>
              <Text
                style={[
                  styles.item1,
                  {textAlign: 'center'},
                ]}>{`Savings A/c Required`}</Text>
            </View>
            <View style={[styles.view2]}>
        ...
        <View style={styles.view4}>
          <View style={styles.container}>
            ...
            <View style={styles.view2}>
              <Text style={styles.item}>
                {details.flexi_auto_sweep == 0 ? 'No' : 'Yes'}
              </Text>
        ...
        {details.insuarance_terms == null || details.insuarance_terms == '' ? (
          <View />
        ) : (
          <View style={styles.top}>
        ...
        {details.pan_required == null || details.pan_required == '' ? (
          <View />
        ) : (
          <View style={styles.top}>
        ...
        {details.premature_withdrawals == null ||
        details.premature_withdrawals == '' ? (
          <View />
        ) : (
          <View style={styles.top}>
        ...
        {details.loan == null || details.loan == '' ? (
          <View />
        ) : (
          <View style={styles.top}>
        ...
        {details.tds_limit == null || details.loanamount == '' ? (
          <View />
        ) : (
          <View style={styles.top}>
            <Text style={styles.tds}>TDS :</Text>
            <Text style={{fontSize: 14, color: colors.textColor}}>
              {parseInt(details.loanamount) > parseInt(details.tds_limit)
                ? 'Yes'
                : 'No'}
            </Text>
          </View>
