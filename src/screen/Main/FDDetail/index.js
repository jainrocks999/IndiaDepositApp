          ...
          <Header
            ...
            <View>
                <View style={styles.list}>
                  ...
                  <Text style={{marginTop:10,fontSize:14,color:colors.bc,fontFamily:'Montserrat-Medium'}}>Regular Fixed Deposit</Text>
                   <Text style={{marginTop:6,fontSize:12,fontFamily:'Montserrat-Medium'}}>Fixed Deposit</Text>
                </View>
            </View>
            ...
            <View style={styles.button}>
                <TouchableOpacity style={styles.btCont}>
                    <Text style={{color:'white',fontFamily:'Montserrat-Normal',}}>CREATE FD</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.btCont}>
                    <Text style={{color:'white',fontFamily:'Montserrat-Normal',}}>DOWNLOAD FORM</Text>
                </TouchableOpacity>
            </View>
            </ScrollView>
        </View>
